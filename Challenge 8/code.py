#today added a temperature sensor to the kit. The below code will take the reading from the temperature sensor and have the light changes based on temperature as well as the buzzer go off if going too low.
