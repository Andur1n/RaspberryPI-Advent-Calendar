#today's project added a beam sensor that could be interrupted. The below code is the final code that is basically a little game that checks if you can break the beam enough times within a certain timeframe.
