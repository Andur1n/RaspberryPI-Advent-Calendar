#Today a light sensor was added and we used the traffic light LED's to indicate how much light the sensor was "sensing". We then amended the code to include the buzzer from yesterday which in the below code goes off if the light sensor value drops below 30%
# Imports
